    ...
    public class Runner
    {
        ...
        public static void Main(string[] args)
        {
            ...
            while (userInput != "q")
            {
                ...
                var selection = stock[int.Parse(userInput)];
                ...
                while (cost != totalPrice)
                {
                    ...
                    cost += _vendingMachine.InsertCoin(new Money(cents)).GetTotalCents();
                ...
                _vendingMachine.UpdateProduct(int.Parse(userInput), selection.Name, selection.Price,
